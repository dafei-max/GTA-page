...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const logoContontainer = document.querySelector(".logo-container");
    const logoMask = document.getElementById("logoMask");

    logoMask.setAttribute("d", logoData);

    const logoDimensions = logoContontainer.getBoundingClientRect();
    ...
    ScrollTrigger.create({
        ...
        onUpdate: (self) => {
            ...
            if (scrollProgress >= 0.6 && scrollProgress <= 0.85) {
                ...
                overlayCopy.style.background = `linear-gradient(to bottom,#111117 0%,
                #111117 ${gradientTopPosition}%,#e56461 ${gradientBottomPosition}%,#e66461 100%)`;
